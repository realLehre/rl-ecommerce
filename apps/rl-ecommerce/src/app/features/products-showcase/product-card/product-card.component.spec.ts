...
fdescribe('ProductCardComponent', () => {
  ...
  // it('should navigate to product details on onViewDetails', () => {
  //   const slug = 'test-product';
  //   productServiceSpy.createSlug.and.returnValue(slug);
  //   spyOn(activeProductSignal, 'set');
  //   spyOn(seeingFullReviewSignal, 'set');
  //   component.onViewDetails(mockProduct);
  //   expect(activeProductSignal.set).toHaveBeenCalledWith(mockProduct);
  //   // expect(productServiceSpy.activeProduct()).toBe(mockProduct);
  //   // expect(reviewServiceSpy.seeingFullReview()).toBe(false);
  //   expect(component.seeDetails.emit).toHaveBeenCalled();
  //   expect(routerSpy.navigate).toHaveBeenCalledWith(['/product/' + slug], {
  //     queryParams: { id: mockProduct.id },
  //   });
  // });
  //
  // it('should create guest cart and dispatch addToCart action on onAddToCart', () => {
  ...
  // });
  //
  // it('should dispatch updateCartItem action on onAdjustQuantity', () => {
  //   const newQuantity = 3;
  //   component.onAdjustQuantity(newQuantity);
  //
  //   expect(storeSpy.dispatch).toHaveBeenCalledWith(
  //     jasmine.objectContaining({
  //       type: '[Cart] Update Cart Item',
  //       unit: newQuantity,
  //       product: mockProduct,
  //     }),
  //   );
  // });
  //
  // it('should return correct star width', () => {
  //   productServiceSpy.getProductCartStarWidth.and.returnValue('50%');
  //   const width = component.getStarWidth(1);
  //   expect(width).toBe('50%');
  //   expect(productServiceSpy.getProductCartStarWidth).toHaveBeenCalledWith(
  //     1,
  //     4.5,
  //   );
  // });
